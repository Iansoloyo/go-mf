...
func initGenesis(ctx *cli.Context) error {
	...
	if len(genesisPath) == 0 {
		...
		contract, tx, err := chain3go.ClientDeployContract(client , string(keystore) , parentContext.String("password"), "",genesis.Config.ChainID,big.NewInt(int64(genesis.Config.Pbft.Period)), big.NewInt(int64(genesis.Config.Pbft.FlushEpoch)),initialValidators,big.NewInt(int64(totalSupply)))
		if err != nil {
